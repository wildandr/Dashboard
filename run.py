...
# Menggunakan fungsi get_input untuk memasukkan nilai dengan nilai default
input_ni = get_input("Masukkan Ni", 2.055)
input_fe = get_input("Masukkan Fe", 13.265)
input_sio2 = get_input("Masukkan SiO2", 39.84)
input_cao = get_input("Masukkan CaO", 0.46)
input_mgo = get_input("Masukkan MgO", 23.195)
input_al2o3 = get_input("Masukkan Al2O3", 1.8)
input_fe_ni = get_input("Masukkan Fe/Ni Ratio", 6.451668721)
input_s_m = get_input("Masukkan S/M Ratio", 1.718814135)
input_bc = get_input("Masukkan BC", 0.590599279)
input_loi_in = get_input("Masukkan LOI_in", 13.195)
input_mc_kilnfeed = get_input("Masukkan MC Kilnfeed", 20.955)
input_fc_coal = get_input("Masukkan FC Coal", 44.71)
input_gcv_coal = get_input("Masukkan GCV Coal", 658.97)
input_tco = get_input("Masukkan TCO", 144.21)
input_charge_klin = get_input("Masukkan Charge Klin", 2242.24)
